...
def main():
    ...
    train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=8, collate_fn=collect_fun, shuffle=True,
                                                   num_workers=8)
    ...
    torch.save(model_head.state_dict(), 'model_head.pth')
